	...
	public static Accommodation createTestAccommodation(Long id) {
		return Accommodation.builder()
			...
			.address(Address.builder()
				...
				.location(GeoFactory.createPoint(127.0629804, 37.4966645))
				.build())
			.labels(List.of())
			.name("서울 시내 모던룸1")
		...
		return List.of(
			...
			Accommodation.builder()
				.address(Address.builder()
					.baseAddress("서울특별시 강남구")
					.country("KR")
					.location(GeoFactory.createPoint(127.0629805, 37.4966646))
					.build())
				.name("서울 시내 모던룸2")
			...
			Accommodation.builder()
				.address(Address.builder()
					.baseAddress("서울특별시 강남구")
					.country("KR")
					.location(GeoFactory.createPoint(127.0629806, 37.4966644))
					.build())
				.name("서울 시내 모던룸3")
				.description("지하철과 가까운 깔끔한 원룸")
				.pricePerDay(7000)
			...
			Accommodation.builder()
				.address(Address.builder()
					.baseAddress("서울특별시 강남구")
					.country("KR")
					.location(GeoFactory.createPoint(127.0629805, 37.4966636))
					.build())
				.name("서울 시내 모던룸4")
				.description("지하철과 가까운 깔끔한 원룸")
				.pricePerDay(730000)
			...
			Accommodation.builder()
				.address(Address.builder()
					.baseAddress("서울특별시 강남구")
					.country("KR")
					.location(GeoFactory.createPoint(127.0629805, 37.4966626))
					.build())
				.name("서울 시내 모던룸5")
			...
			Accommodation.builder()
				.address(Address.builder()
					.baseAddress("서울특별시 강남구")
					.country("KR")
					.location(GeoFactory.createPoint(127.0629804, 37.4966646))
					.build())
				.name("서울 시내 모던룸6")
			...
			Accommodation.builder()
				.address(Address.builder()
					.baseAddress("강원도 강릉시")
					.country("KR")
					.location(GeoFactory.createPoint(129.1741038, 35.1719465))
					.build())
				.name("강릉 오션뷰 하우스")
			...
			Accommodation.builder()
				.address(Address.builder()
					...
					.country("KR")
					.location(GeoFactory.createPoint(129.206998, 35.8447433))
					.build())
				.name("경주 전통 한옥")
			...
			Accommodation.builder()
				.address(Address.builder()
					...
					.country("KR")
					.location(GeoFactory.createPoint(126.5609945, 33.2532177))
					.build())
				.name("제주 중문 풀빌라")
			...
			Accommodation.builder()
				.address(Address.builder()
					...
					.country("KR")
					.location(GeoFactory.createPoint(129.1201036, 35.1610936))
					.build())
				.name("부산 광안리 룸")
